...
PATH_dataset ='E:\RMT\Dataset\MoCap\data\';
saveFeaturesPath='E:\RMT\Dataset\MoCap\MotifsFeatures\';
...
for TSname =1:TS_num
    ...
    if FeatureExtractionFlag == 1
        ...
        TIMEFOROCTAVE = MoCap_FE_start(PATH_dataset,saveFeaturesPath,TS_name, USER_OT_targhet, USER_OD_targhet);
    end
