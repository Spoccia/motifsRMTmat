...
PATH_dataset ='E:\RMT\Dataset\BirdSong\data52variateexpanded\';
saveFeaturesPath='E:\RMT\Dataset\BirdSong\MotifsFeatures\';
...
for TSname =1:TS_num
    ...
    if FeatureExtractionFlag == 1
        ...
        TIMEFOROCTAVE = BirdSong_FE_start(PATH_dataset,saveFeaturesPath,TS_name, USER_OT_targhet, USER_OD_targhet);
    end
